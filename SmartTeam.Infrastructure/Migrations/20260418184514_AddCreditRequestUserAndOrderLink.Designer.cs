...
namespace SmartTeam.Infrastructure.Migrations
{
    ...
    [Migration("20260418184514_AddCreditRequestUserAndOrderLink")]
    partial class AddCreditRequestUserAndOrderLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.AppSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.InstallmentConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InstallmentConfigurations", (string)null);
                });

            modelBuilder.Entity("SmartTeam.Domain.Entities.InstallmentOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InstallmentOptions", (string)null);
                });
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<decimal?>("InstallmentInterestPercentage")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EpointTransactionId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("EpointTransactionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.PendingOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.Payment", b =>
                {
                    b.HasOne("SmartTeam.Domain.Entities.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("SmartTeam.Domain.Entities.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SmartTeam.Domain.Entities.PendingOrder", "PendingOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.Wallet", b =>
                {
                    b.HasOne("SmartTeam.Domain.Entities.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("SmartTeam.Domain.Entities.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartTeam.Domain.Entities.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("SmartTeam.Domain.Entities.Wallet", "Wallet")
